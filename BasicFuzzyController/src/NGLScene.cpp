...
void NGLScene::initializeGL()
{
  ...
  iv.transpose();
  ngl::Light light(ngl::Vec3(-12,15,2),ngl::Colour(1,0,0,0.5),ngl::Colour(1,1,1,1),ngl::LightModes::POINTLIGHT);
  ...
  //ngl::Light light2(ngl::Vec3(-2,5,2),ngl::Colour(1,1,1,1), ngl::LightModes::POINTLIGHT);
...
void NGLScene::paintGL()
{
  ...
  loadMatricesToShader();
   ...
   // TODO:: Replace with drawing of light bulb model
  ngl::VAOPrimitives *prim=ngl::VAOPrimitives::instance();
  prim->createSphere("bulb", 0.5, 50);
  prim->draw("bulb");
}
